...
public class HttpSendClientFactory {
     ...
     * {@link org.apache.http.client.HttpClient HttpClient} to the Platform from
     * the client.
     */
    private static final String AGENT = "ins-common-util_HttpSendClient";
    ...
    public HttpSendClient newHttpSendClient() {
        return new HttpSendClient(newHttpClient());
    }
	...
	public HttpClient newHttpClient() {
        ...
        ConnectionKeepAliveStrategy connectionKeepAliveStrategy = new TimedConnectionKeepAliveStrategy(12);
